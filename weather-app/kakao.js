...
async function fetchExternalData() {
    try {
        // OpenWeather API 호출 (API 키는 실제 키로 교체 필요)
        ...
        return {
            title: `서울의 현재 날씨`,
            description: `현재 온도: ${data.main.temp}°C\n체감 온도: ${data.main.feels_like}°C\n습도: ${data.main.humidity}%\n${data.weather[0].description}`,
    ...
    try {
        ...
        const templateObject = {
            ...
            content: {
                ...
                link: {
                    web_url: `https://rrolssu.github.io/weather-app/news_detail.html?title=${encodeURIComponent(newsData.title)}&description=${encodeURIComponent(newsData.description)}&url=${encodeURIComponent(newsData.url)}&imageUrl=${encodeURIComponent(newsData.imageUrl)}`,
                    mobile_web_url: `https://rrolssu.github.io/weather-app/news_detail.html?title=${encodeURIComponent(newsData.title)}&description=${encodeURIComponent(newsData.description)}&url=${encodeURIComponent(newsData.url)}&imageUrl=${encodeURIComponent(newsData.imageUrl)}`
                }
            },
            buttons: [
                {
